...
export function Sidebar(props: SidebarProps){
    ...
    return(
        <div className="w-16 sm:w-20 md:w-56 lg:w-72 h-screen border-r fixed border-purple-800/50 bg-slate-900/95 backdrop-blur-sm p-2 sm:p-3 md:p-4 transition-all duration-300">
